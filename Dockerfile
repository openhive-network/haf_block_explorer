...
# Below is placed rewriter image definition, reiusing openapi-generator target
...
COPY --from=openapi-generator /haf_block_explorer/scripts/output/rewrite_rules.conf /usr/local/openresty/nginx/conf/rewrite_rules.conf
